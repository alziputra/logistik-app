          ...
          <table className="w-full text-left text-xs whitespace-nowrap">
            <thead className="bg-slate-50 dark:bg-slate-950 text-slate-500 dark:text-slate-400 border-b border-slate-200 dark:border-slate-800 font-bold uppercase tracking-wider">
              <tr>
                ...
                {(userRole === "admin" || userRole === "officer") && <th className="px-5 py-3.5 text-center">Aksi</th>}
              </tr>
            </thead>
            <tbody className="divide-y divide-slate-100 dark:divide-slate-800">
              {filtered.length === 0 ? (
                <tr>
                  <td colSpan={(userRole === "admin" || userRole === "officer") ? "8" : "7"} className="px-6 py-10 text-center text-slate-400 italic">
                  ...
                  <tr key={v.id || idx} className="hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors">
                    ...
                    <td className="px-5 py-3.5 font-bold text-slate-900 dark:text-slate-100">
                      <div className="flex items-center gap-2">
                        ...
                        <span>{v.nama_perusahaan || v.nama || "-"}</span>
                      </div>
                    </td>

                    {/* Pimpinan & Jabatan */}
                    <td className="px-5 py-3.5">
                      <div className="font-semibold text-slate-800 dark:text-slate-200">{v.pimpinan || "-"}</div>
                      <div className="text-[11px] text-slate-400">{v.jabatan || "-"}</div>
                    </td>

                    {/* Bidang */}
                    <td className="px-5 py-3.5">
                      <span className="px-2.5 py-1 rounded-full text-[10px] font-bold bg-emerald-50 dark:bg-emerald-950 text-[#00753A] dark:text-emerald-400 border border-emerald-200 dark:border-emerald-800">
                        {v.keterangan || "BANGUNAN"}
                      </span>
                    </td>
                    ...
                    <td className="px-5 py-3.5 text-slate-600 dark:text-slate-300">
                      <div className="flex items-center gap-1.5">
                        ...
                        <span className="truncate max-w-62.5" title={v.alamat}>{v.alamat || "-"}</span>
                      </div>
                    </td>
                      ...
                      <td className="px-5 py-3.5 text-center">
                        <div className="flex justify-center gap-1.5">
                          ...
                          <button
                            ...
                            className="p-1.5 bg-slate-100 dark:bg-slate-800 hover:bg-rose-50 dark:hover:bg-rose-950 text-rose-500 rounded-lg cursor-pointer transition-colors"
