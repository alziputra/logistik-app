        ...
        <form onSubmit={onSave} className="p-6">
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 border rounded-lg bg-gray-100 text-gray-500 outline-none text-sm"
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div className="col-span-2">
                  ...
                  <select
                    ...
                    disabled={isSaving}
                    className="w-full px-3 py-2 border rounded-lg bg-gray-100 outline-none text-sm font-medium"
                  >
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  ...
                  <input
                    ...
                    disabled={isSaving}
                    className="w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-purple-500 outline-none text-sm font-mono text-blue-700"
                    placeholder="10.81..."
                  />
                </div>
                <div>
                  ...
                  <input
                    ...
                    disabled={isSaving}
                    className="w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-purple-500 outline-none text-sm font-mono"
                ...
                <div className="col-span-2 mt-2">
                  ...
                  <input
                    ...
                    placeholder="Misal: Intel Core i5-14500"
                  />
                </div>
                <div>
          ...
          <div className="flex justify-end gap-3 pt-6 mt-4 border-t sticky bottom-0 bg-white">
            <button
              ...
              onClick={onClose}
              disabled={isSaving}
              className="px-6 py-2.5 text-gray-600 hover:bg-gray-100 rounded-xl font-medium transition-colors disabled:opacity-50"
            >
              Batal
            </button>
            <button
              type="submit"
              disabled={isSaving}
              className="px-6 py-2.5 bg-blue-600 hover:bg-blue-700 text-white rounded-xl font-medium shadow-sm transition-colors flex items-center gap-2 disabled:bg-blue-400"
            >
