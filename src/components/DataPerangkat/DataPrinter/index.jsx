...
export default function DataPrinter({ userRole }) {
  // Destrukturisasi untuk mencegah false-positive error react-hooks/refs
  const {
    downloadTemplate,
    fileInputRef,
    isSaving,
    ...
    outletsList,
    inventoryList,
    snList, // Ingat, printer punya snList tambahan dibanding komputer
    handleSave,
    handleOutletChange,
    handleProdukChange,
    handleDateChange,
          ...
          {userRole === "admin" && (
            <div className="flex flex-wrap items-center gap-2">
              ...
              <input
                ...
                className="hidden"
                aria-label="Upload file CSV data printer"
              />
