// src/components/DataPerangkat/DataPrinter/usePrinterData.js
"use client";

import { useState, useEffect, useRef } from "react";
import Papa from "papaparse";
import {
  fetchPrinter, fetchDropdowns,
  addPrinter, updatePrinter, deletePrinter,
  importPrinterCSV, downloadTemplate,
} from "./printerService";
import { calculateAutoStatus, emptyForm } from "./printerUtils";
...
export function usePrinterData() {
  ...
  return {
    // data
    paginatedData, filteredData, printerData,
