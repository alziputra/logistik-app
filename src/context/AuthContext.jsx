...
export const AuthProvider = ({ children }) => {
  ...
  const login = async (email, password) => {
    try {
      ...
      addActivityLog({
        ...
        modul: "AUTENTIKASI",
        aksi: "LOGIN",
        keterangan: `Pengguna ${userData.name} (${userData.email}) berhasil login ke sistem`,
      });
      ...
      if (email && password) {
        ...
        addActivityLog({
          ...
          modul: "AUTENTIKASI",
          aksi: "LOGIN",
          keterangan: `Pengguna ${fallbackUser.name} (${fallbackUser.email}) berhasil login ke sistem`,
        });
  ...
  return <AuthContext.Provider value={{ user, token, isAuthenticated, loading, login, register, logout, setUser }}>{children}</AuthContext.Provider>;
};
